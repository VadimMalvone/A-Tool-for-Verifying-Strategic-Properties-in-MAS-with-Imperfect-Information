...
//        FileWriter fw = new FileWriter(file);
    ...
    public static void main(String[] args) throws Exception {
        AtlModel model = JsonObject.load(AbstractionUtils.readSampleFile(), AtlModel.class);
        AbstractionUtils.validateAtlModel(model, false);
        System.out.println(AtlModel.modelCheck(model));
